...
extern int  margo_client_timeout_msec;
extern int  margo_client_retry_count;
extern int  margo_service_pool_sz;
extern int  margo_service_retry_count;
extern int  margo_service_timeout_msec;
